...
public class ThuongHieu {
    @Id @GeneratedValue(strategy=GenerationType.IDENTITY) @Column(name="MaTH") private Integer maTH;
    @Column(name="TenTH") private String tenTH;
    ...
    public Integer getMaTH(){return maTH;} public void setMaTH(Integer maTH){this.maTH=maTH;}
    public String getTenTH(){return tenTH;} public void setTenTH(String tenTH){this.tenTH=tenTH;}
