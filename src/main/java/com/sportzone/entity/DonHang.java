...
public class DonHang {
    ...
    public void pre() {
        ...
        if (phiVanChuyen == null) phiVanChuyen = BigDecimal.valueOf(30000);
        if (giamGia == null) giamGia = BigDecimal.ZERO;
        if (trangThaiDonHang == null) trangThaiDonHang = "Chờ xác nhận";
        if (trangThaiThanhToan == null) trangThaiThanhToan = "Chưa thanh toán";
    }
