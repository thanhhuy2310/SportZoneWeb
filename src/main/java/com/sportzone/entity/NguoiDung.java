...
public class NguoiDung {
    @Id @GeneratedValue(strategy=GenerationType.IDENTITY) @Column(name="MaND") private Integer maND;
    ...
    @Column(name="VaiTro") private String vaiTro="USER";
    ...
    @Column(name="NgayTao") private LocalDateTime ngayTao;
    @PrePersist public void pre(){ if(ngayTao==null)ngayTao=LocalDateTime.now(); if(vaiTro==null) vaiTro="USER"; if(trangThai==null) trangThai=true; }
    public Integer getMaND(){return maND;} public void setMaND(Integer maND){this.maND=maND;}
